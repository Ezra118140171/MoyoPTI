        ...
        <div class="max-w-lg px-6 py-3">
            <form action="" method="POST">
                <div class=" border-gray-400">
                    ...
                    <div>
                        <x-label for="name" value="Nama Makanan atau Minuman" />
                        <x-input type="text" name="name" id="name" required
                        />
                    </div>
                    <div>
                        <x-label for="harga" value="Harga Makanan atau Minuman"/>
                        <x-input type="text" name="harga" id="harga" required
                        />
                    </div>
                    <div >
                        <x-label for="foto" value="Foto Makanan"/>
                        <label class='flex flex-col border-4 border-dashed w-full h-32 hover:bg-blue-200 hover:border-blue-300 group'>
                            <div class='flex flex-col items-center justify-center pt-7'>
                              ...
                              <p class='lowercase text-sm text-blue-400 group-hover:text-blue-600 pt-1 tracking-wider'>Select a photo</p>
                            </div>
